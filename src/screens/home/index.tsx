...
import { Header, Main, Section, Filters, InputGroup, Balance, ChartContainer, ChartContent, ChartAction, Aside, SearchTransaction, TransactionGroup, CategoryBadge } from "./styles";
...
export function Home() {
    ...
    const { transactions, dashboard, financialEvolution, fetchTransactions, fetchDashboard, fetchFinancialEvolution } = useFetchAPI()
        ...
        <Main>
            <Section>
                ...
                <ChartContainer>
                    <header>
                        ...
                        />
                        <ButtonIcon onClick={financialEvolutionFilterForm.handleSubmit(
            ...
            <TransactionGroup>
                {transactions?.length && (
                    ...
                    category={{title:
                        item.category.title, color: item.category.color}}/>
                    ))
                )}
            </TransactionGroup>
            </Aside>
